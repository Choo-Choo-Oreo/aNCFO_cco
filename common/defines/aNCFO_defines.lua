...
-- Frontline Ai Snoopy Alternative Defines
	...
	NDefines.NMilitary.PLAN_EXECUTE_CAREFUL_MAX_FORT = 11				-- If execution mode is set to careful, units will not attack provinces with fort levels greater than or equal to this
	...
	NDefines.NAI.FRONT_EVAL_UNIT_ACCURACY = 3.0								-- scale how stupid ai will act on fronts. 0 is potato
