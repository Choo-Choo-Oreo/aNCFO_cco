-- aNCFO Defines
	...
	-- NBuildings
		...
		NDefines.NBuildings.MAX_BUILDING_LEVELS = 55
	...
	-- NAI
		...
		NDefines.NAI.UPDATE_SUPPLY_BOTTLENECKS_FREQUENCY_HOURS = 252 -- Base 168
		NDefines.NAI.FIX_SUPPLY_BOTTLENECK_SATURATION_THRESHOLD = 0.75
		NDefines.NAI.UPDATE_SUPPLY_MOTORIZATION_FREQUENCY_HOURS = 78 -- Base 52
		NDefines.NAI.RESEARCH_DAYS_BETWEEN_WEIGHT_UPDATE = 21 -- Base 7
